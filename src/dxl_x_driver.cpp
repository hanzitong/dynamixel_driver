...
//         portHandler_ = dynamixel::PortHandler::getPortHandler(device_file_);    // memory leak
//         packetHandler_ = dynamixel::PacketHandler::getPacketHandler(PROTOCOL_VERSION);  // memory leak
...
//     double step_read_present_current(){ // changed type 
